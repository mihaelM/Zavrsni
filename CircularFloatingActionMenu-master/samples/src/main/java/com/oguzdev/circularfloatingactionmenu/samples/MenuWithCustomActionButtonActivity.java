...
public class MenuWithCustomActionButtonActivity extends ActionBarActivity {
    ...
    public static class CustomButtonDemoFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView g = new TextView(getActivity()); g.setText("ge"); g.setBackgroundResource(android.R.drawable.btn_default_small);
            ...
            FloatingActionMenu circleMenu = new FloatingActionMenu.Builder(getActivity())
                    ...
                    .setEndAngle(360)
                    .setRadius(getResources().getDimensionPixelSize(R.dimen.radius_medium)) //radius
                    .addSubActionView(a)
                    .addSubActionView(b)
                    .addSubActionView(c)
                    .addSubActionView(d)
